...
public class MenuViewController {
	...
	public String updateMenu(@PathVariable Long id, @RequestParam("name") String name,
			@RequestParam("simpleExp") String simpleExp, @RequestParam("component") String component,
	...
	@PostMapping("/save")
	public String saveMenu(@RequestParam("name") String name, @RequestParam("simpleExp") String simpleExp,
			@RequestParam("component") String component, @RequestParam("price") String price,
