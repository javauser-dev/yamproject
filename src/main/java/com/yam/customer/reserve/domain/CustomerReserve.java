...
public class CustomerReserve {
	...
	public CustomerReserve(LocalDate reserveDate, LocalTime reserveTime, int guestCount, int deposit, String request,
			int reserveCheck, int reserveCancel, Shop shop, Member member) {
