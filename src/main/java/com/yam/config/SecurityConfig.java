...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(authz -> authz.requestMatchers("/admin/**", "/dashboard/**")
						.hasAuthority("ROLE_ADMIN").requestMatchers("/store/**")
						.hasAnyAuthority("ROLE_ADMIN", "ROLE_STORE").requestMatchers("/customer/**")
						.hasAnyAuthority("ROLE_ADMIN", "ROLE_CUSTOMER").anyRequest().permitAll())
